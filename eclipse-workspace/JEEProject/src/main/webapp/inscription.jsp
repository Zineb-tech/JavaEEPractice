			...
			<form autocomplete="off">
				<div class="form-group">
					...
					<input class="input_field" type="text" name="fullName">
						...
						<span class="input__label-content">Nom complet</span>
					</label>
					</span>
				...
				<button type="submit" name="submit" class="btn_1 rounded full-width add_top_30">S'inscrire</button>
				<div class="text-center add_top_10">Vous avez déjà un compte ? <strong><a href="connexion.html">Se connecter</a></strong></div>
			</form>
